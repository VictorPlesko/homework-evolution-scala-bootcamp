package by.plesko.bootcamp.json
...
object HomeworkSpec {
  ...
  import io.circe.generic.extras.defaults.defaultGenericConfiguration       // import default configuration

  implicit lazy val encodeLocaleDate: Encoder[LocalDate] = Encoder.encodeLocalDateWithFormatter(DateTimeFormatter.BASIC_ISO_DATE)
  implicit lazy val decoderLocaleDate: Decoder[LocalDate] = Decoder.decodeLocalDateWithFormatter(DateTimeFormatter.BASIC_ISO_DATE)
